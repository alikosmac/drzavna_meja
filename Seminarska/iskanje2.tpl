...
<body bgcolor = "#dcedc8">
<h2 class="center"> Iskanje oseb </h2>


<form action = "/rezultati">
    <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <input id="naslov" name = "naslov" type="text" class="validate">
            ...
            <div class="input-field col s12" style="margin-bottom:30px;">
                <input type="checkbox" id="moski" name = "spol" value = "M"/>
                <label for="moski">Moški</label>
                &nbsp;
                <input type="checkbox" id="zenska" name = "spol" value = "F"/>
        ...
        <div class="input-field col s6">
                <input placeholder = "XX00000000" maxlength = 10 id="st_dokumenta" name = "st_dokumenta" type="text" class="validate">
        ...
        <div class="input-field col s6">
                <select multiple name = "mejniPrehod">
        ...
        <div class="input-field col s12">
            <input type="submit" value="Išči" class="btn waves-effect waves-light" />
        </div>
